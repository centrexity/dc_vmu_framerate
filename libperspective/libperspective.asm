...
%macro P_Set_Pixel_Black %pixel_x, %pixel_y
        ...
        mov #%pixel_x, p_spr_x
        mov #%pixel_y, p_spr_y
        callf P_Get_Px_Coord
        callf P_Set_Bit_Framebuffer
%end
